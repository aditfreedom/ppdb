<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><b>APPROVAL DAFTAR ULANG</b></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <table class="table table-hover table-striped table-sm text-sm table-responsive-sm" id="example">
      <thead class="text-center bg-dark">
        <tr>
          ...
          <th class="text-center align-middle" scope="col">APPROVAL DAFTAR ULANG</th>
      ...
      <tbody>
        ...
        foreach ($daftarulang as $data) : ?>
          <tr class="nomor text-center">
            ...
            ?>
            <td class="text-center align-middle"><a class="font-weight-bold text-uppercase rounded-pill <?= $class; ?>" href="#" role="button" style="width:60px;">&nbsp&nbsp<?php echo $data->approve_daftarulang ?>&nbsp&nbsp</a></td>
            <td class="text-center align-middle"><?php echo anchor('home/editdaftarulang/' . $data->id, '<div class="btn btn-primary btn-sm"><b>EDIT DATA</b></div>') ?> <br><br>
