    ...
    <section class="content">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="text-light"><b>Cetak Berkas Pendaftaran Ulang</b></h4>
            </div>
            <div class="card-body">
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <h4><b>Syarat Berkas Pendaftaran Ulang PPDB 2023/2024</b></h4>
                        <ul>
                            <li>Mengisi dan Mencetak Formulir Pendaftaran Ulang</li>
                            <li>Surat Pernyataan Orang Tua 1 lembar (materai 10.000 disediakan sendiri oleh orang tua)</li>
                            <li>Surat Pakta Integritas Siswa 1 lembar (materai 10.000 disediakan sendiri oleh orang tua)</li>
                            <li>Photocopy Akta kelahiran Peserta Didik 1 lembar</li>
                            <li>Photocopy Kartu Keluarga (KK) 1 lembar</li>
                            <li>Photocopy KTP kedua Orang Tua masing-masing 1 lembar</li>
                            <li>Photocopy Kartu NISN Peserta Didik 1 lembar</li>
                            <li>Pas foto Terbaru Peserta Didik dengan Latar Merah 3x4 cm dan 2x3 cm masing-masing 2 lembar</li>
                            <li>Foto copy Ijazah/Surat Keterangan Lulus 1 lembar</li>
                            <li>Menunjukkan Bukti Pembayaran BPP (Virtual Account) resmi dari TU</li>
                            <li>Menunjukkan Slip Biaya Perawatan Sekolah resmi dari TU</li>
                            <li>Menunjukkan Slip Pembayaran Paket Seragam resmi dari Koperasi Sekolah SSB Bireuen</li>
                            <li>Surat Pindah dari Sekolah Asal (khusus bagi siswa pindahan)</li>
                            <li>Photocopy Rapor (khusus bagi siswa pindahan)</li>
                            <li>Print Surat Mutasi Dapodik (khusus bagi siswa pindahan) (berisi keterangan bahwa calon siswa tersebut sudah di keluarkan dari dapodik di sekolah asal)</li>
                            <li>Menunjukkan slip pembayaran kartu siswa dan OSIS (Khusus SMP dan SMA)</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <h4 class="text-dark"><b>Download Dan Cetak Berkas Berikut</b></h4>
                        <ul class="text-light">
                            <li>
                                <?php foreach ($cetakdaftarulang as $data) : ?>
                                    <form method="post" action="<?php echo base_url() . 'user/cetakformulirdaftarulanguser'; ?>">
                                        ...
                                        <p align="left"><button type="submit" class="btn btn-primary font-weight-bold"><i class="fa fa-print"></i> CETAK FORMULIR PENDAFTARAN ULANG</button></p>
                                    </form>
                                <?php endforeach; ?>

                                <?php foreach ($cetakdaftarulang as $data) : ?>
                                    <form method="post" action="<?php echo base_url() . 'user/cetaksuratpernyataanuser'; ?>">
                                        <div hidden>
                                            <div hidden class="form-group">
                                                <label for="">ID</label>
                                                <input type="text" name="id" class="form-control" value="<?php echo $data->id; ?>">
                                        ...
                                        <p align="left"><button type="submit" class="btn btn-danger font-weight-bold"><i class="fa fa-print"></i> CETAK SURAT PERNYATAAN</button></p>
                                    </form>
                                <?php endforeach; ?>

                                <?php foreach ($cetakdaftarulang as $data) : ?>
                                    <form method="post" action="<?php echo base_url() . 'user/cetakpaktaintegritasuser'; ?>">
                                        <div hidden>
                                            <div hidden class="form-group">
                                                <label for="">ID</label>
                                                <input type="text" name="id" class="form-control" value="<?php echo $data->id; ?>">
                                        ...
                                        <p align="left"><button type="submit" class="btn btn-warning font-weight-bold"><i class="fa fa-print"></i> CETAK PAKTA INTEGRITAS</button></p>
                                    </form>
                            </li>
                        </ul>
                    <?php endforeach; ?>
                ...
                <div class="card shadow p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <h4 class="text-dark"><b>Perhatian :</b></h4>
                        <ul>
