        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php foreach ($cetakdaftarulang as $data) : ?>
                    <h5>Anda Sudah Mencapai Tahap Finalisasi Pendaftaran Ulang<br>Pastikan Anda Telah Melengkapi Data Pendaftaran Ulang <a href="<?= base_url('user/registrasi_ulang/') . $data->id ?>">DISINI</a><br>Agar Print Out Hasil Formulir Pendaftaran Ulang, Surat Pernyataan dan Pakta Integritas Tidak Kosong</h5>
                <?php endforeach; ?>
                <?php foreach ($cetakdaftarulang as $data) : ?>
                ...
                <?php endforeach; ?>
                <h4 class="text-bold text-danger">*Harap Ketiga Dokumen Diatas Dibawakan Saat Proses Pendaftaran Ulang Bersama Dengan Dokumen Sesuai Pada Pengumuman Persyaratan Daftar Ulang</h4>
            </div>
        </div>
</div>
</section>
