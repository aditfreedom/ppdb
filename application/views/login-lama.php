        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <?php echo form_open('hal/login_admin_aksi');?>
              ...
              <div class=" d-flex justify-content-center" style="margin-top:20px; font-family: 'Varela Round', sans-serif;" ><strong >AREA CALON SISWA <a class="text-info"href="<?php echo base_url('hal/login');?>">DISINI</a></strong></div>
              <?php echo form_close();?>
