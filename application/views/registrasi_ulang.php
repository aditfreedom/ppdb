          ...
          <div class="row">
            <div class="col">
              ...
              <div class="form-group">
                ...
                <input type="number" name="hp_ayah" class="form-control" placeholder="Contoh : 6281376876109"
                  maxlength="15" value="<?php echo $data->hp_ayah;?>"
                  required>
              </div>
            </div>
            ...
            <div class="col">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="form-group">
                    <label for="">Alamat Jalan <a class="btn btn-danger btn-sm text-light text-decoration-none"><b>Klik
                          Jika
                          Alamat Ayah Sama Dengan
                          Anak</b></a></label>
                    <textarea class="form-control" name="alamat_ayah" rows="1" placeholder="Alamat Jalan"
                      maxlength="450"
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        <label for="">Desa, Kecamatan</label>
                        <input type="text" name="desa_ayah" class="form-control" placeholder="Desa, Kecamatan"
                          maxlength="45"
                          value="<?php echo $data->desa_ayah;?>"
                          required>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group">
                        <label for="">Kabupaten</label>
                        <input type="text" name="kabupaten_ayah" class="form-control" placeholder="Kabupaten"
                          maxlength="45"
                    ...
                    <div class="col">
                      <div class="form-group">
                        <label for="">Provinsi</label>
                        <input type="text" name="provinsi_ayah" class="form-control" placeholder="Provinsi"
                          maxlength="45"
          ...
          <div class="row">
            <div class="col">
              ...
              <div class="form-group">
                ...
                <input type="number" name="hp_ibu" class="form-control" placeholder="Contoh : 6281376876109"
                  maxlength="15" value="<?php echo $data->hp_ibu;?>"
                  required>
              </div>
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="tptlahir_ibu" class="form-control"
                      value="<?php echo $data->tptlahir_ibu;?>"
                      required>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        <label for="">Desa, Kecamatan</label>
                        <input type="text" name="desa_ibu" class="form-control" placeholder="Desa, Kecamatan"
                          maxlength="45"
                          value="<?php echo $data->desa_ibu;?>"
                          required>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group">
                        <label for="">Kabupaten</label>
                        <input type="text" name="kabupaten_ibu" class="form-control" placeholder="Kabupaten"
                          maxlength="45"
                    ...
                    <div class="col">
                      <div class="form-group">
                        <label for="">Provinsi</label>
                        <input type="text" name="provinsi_ibu" class="form-control" placeholder="Provinsi"
                          maxlength="45"
                          value="<?php echo $data->provinsi_ibu;?>"
                          required>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col">
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <select class="form-control form-control" name="olah_raga" required="">
                        <option selected="<?=$data->olah_raga;?>"
                          hidden=""><?=$data->olah_raga;?></option>
                        <option>Ya</option>
                        <option>Tidak</option>
                      </select>
                    </div>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="prestasi" rows="2" maxlength="450"
                required><?=$data->prestasi;?></textarea>
            </div>
          </div>
        </div>
