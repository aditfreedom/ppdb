  ...
  <section class="content">
    <div class="card">
      <div class="card-header bg-danger">
        <h3><b>DOWNLOAD BERKAS PENDAFTARAN ULANG</b></h3>
      </div>
      <div class="card-body">
        <table>
          <tr>
            <td> <?php foreach ($daftarulang as $data) : ?>
                <form method="post" action="<?php echo base_url() . 'user/cetakformulirdaftarulanguser'; ?>">
                  ...
                  <p align="right"><button type="submit" class="btn btn-success"><i class="fa fa-print"></i> <b>CETAK FORMULIR DAFTAR ULANG</b></button></p>
                </form>
              <?php endforeach; ?>
            </td>
            <td> <?php foreach ($daftarulang as $data) : ?>
                <form method="post" action="<?php echo base_url() . 'user/cetaksuratpernyataanuser'; ?>">
                  ...
                  <p align="right"><button type="submit" class="btn btn-success"><i class="fa fa-print"></i> <b>CETAK SURAT PERNYATAAN</b></button></p>
                </form>
              <?php endforeach; ?>
            </td>
            <td> <?php foreach ($daftarulang as $data) : ?>
                <form method="post" action="<?php echo base_url() . 'user/cetakpaktaintegritasuser'; ?>">
                  ...
                  <p align="right"><button type="submit" class="btn btn-success"><i class="fa fa-print"></i> <b>CETAK PAKTA INTEGRITAS</b></button></p>
                </form>
              <?php endforeach; ?>
            </td>
          </tr>
    ...
    <div class="card">
      <div class="card-header bg-info">
        <h4><b>APPROVAL PENDAFTARAN ULANG</b></h4>
      </div>
      <div class="card-body">
          ...
          <form method="post" action="<?php echo base_url() . 'home/updatelulus'; ?>">
            ...
            <div class="row">
              <div class="col">
                ...
                <div class="form-group">
                  <label for="">NIK</label>
                  <input readonly type="text" name="nik_siswa" class="form-control" value="<?php echo $data->nik; ?>">
                </div>
                <div class="form-group">
                  <label for="">Golongan Darah</label>
                  <input readonly type="text" name="goldar" class="form-control" value="<?php echo $data->goldar; ?>">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    <div class="form-group">
                      <label for="">Jarak Ke Sekolah (KM)</label>
                      <input readonly type="text" name="jk" class="form-control" value="<?php echo $data->jarak; ?>">
                    </div>
                  </div>
                </div>
              </div>
