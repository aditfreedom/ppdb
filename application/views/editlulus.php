<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><b>EDIT APPROVAL KELULUSAN</b></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="card">
      <div class="card-header bg-info">
        <h3 class="m-0 text-light text-bold">EDIT KELULUSAN</h3>
        </div>
      <div class="card-body">
        <?php foreach ($lulus as $data) : ?>
          <form method="post" action="<?php echo base_url() . 'home/updatelulus'; ?>">
            ...
            <button type="submit" class="btn btn-primary font-weight-bold form-control"><i class="fa fa-save"></i> SIMPAN DATA</button>
          </form>
        <?php endforeach; ?>
      </div>
    </div>
