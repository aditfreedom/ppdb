<div class="content-wrapper">
  ...
  <section class="content">
    <?php foreach ($isi_formulir as $data) : ?>
      ...
      <br>
      <div class="form-group">
        <label for="">UPLOAD AKTE KELAHIRAN <b class="text-danger">(Wajib Bagi Calon Peserta Didik Baru SD)</b> Atau Surat Keterangan/Sertifikat Prestasi <b class="text-danger">(Khusus Jalur Prestasi)</b> [Tipe JPEG/JPG]</label><br>
      ...
      <div class="form-group">
        <label for="">UPLOAD SLIP SETORAN BANK BUKTI PEMBAYARAN FORMULIR <b class="text-danger"> [Tipe JPEG/JPG]</label>
